...
"""This function focuses only on the subfigures"""
#def get_subfigures(json_files):
#    indices =  [1,3,5,6,17,24,39,40,42, 43,46,51, 67,71,75,78,81,87,94, 99]
#    subfigures= []
#    for i, label in enumerate(json_files):
#        if i in indices:
#            subfigures.append(label)
            
#    return subfigures


"""This function receives each subfigure path and loads it"""
...
#subfigures = get_subfigures(json_files)
